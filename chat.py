...
def retrieve_context(query: str) -> str:
    ...
    collection = chroma_client.get_collection(
        name="company_policies", embedding_function=sentence_transformer_ef
    )
...
def answer_query(user_query: str):
    ...
    CRITICAL RULES:
    1. If the answer is not explicitly stated in the context, say "I'm sorry,
      but I don't have that information in my current policy documents."
